...
internal class ArrayContainer : Container, IEquatable<ArrayContainer> {
    ...
    public override bool Contains(ushort x) {
        return Util.UnsignedBinarySearch(_content, 0, _cardinality, x) >= 0;
    }
    ...
    public static Container operator &(ArrayContainer x, ArrayContainer y) {
        ...
        var calculatedCardinality = Util.IntersectArrays(x._content, x._cardinality, y._content, y._cardinality, data);
    ...
    public static Container operator |(ArrayContainer x, ArrayContainer y) {
        ...
        if (totalCardinality > MaxSize) {
            ...
            var calcCardinality = Util.UnionArrays(x._content, x._cardinality, y._content, y._cardinality, output);
        ...
        var data = new ushort[desiredCapacity];
        var calculatedCardinality = Util.UnionArrays(x._content, x._cardinality, y._content, y._cardinality, data);
        return new ArrayContainer(calculatedCardinality, data);
    }
    ...
    public static Container operator ^(ArrayContainer x, ArrayContainer y) {
        ...
        var desiredCapacity = totalCardinality;
        var data = new ushort[desiredCapacity];
        var calculatedCardinality = Util.XorArrays(x._content, x._cardinality, y._content, y._cardinality, data);
        return new ArrayContainer(calculatedCardinality, data);
    }
    ...
    public static Container AndNot(ArrayContainer x, ArrayContainer y) {
        ...
        var data = new ushort[desiredCapacity];
        var calculatedCardinality = Util.DifferenceArrays(x._content, x._cardinality, y._content, y._cardinality, data);
        return new ArrayContainer(calculatedCardinality, data);
    }
